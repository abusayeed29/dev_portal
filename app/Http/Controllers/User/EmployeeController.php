...
class EmployeeController extends Controller
{
    ...
    public function jsonUsers(Request $request){
        ...
        return Datatables::of($employees)
                ...
                ->addColumn('employee_name', function($data){
                    return '<a href="'.route('user.employee.show',$data->user_id).'" class="d-flex align-items-center">
                                <div class="mr-3">
                ...
                ->addColumn('action', function($data){
                    $button = '<a href="'.route('user.employee.show',$data->user_id).'" class="btn btn-light align-items-center btn-sm btn-sm-custom">View</a>';
                    /*$button .= '&nbsp;';*/
    ...
    {   
        $employee = User::leftJoin('employees','users.id','=','employees.user_id')
                ...
                ->first();
        return view('backend.user.employee.show', compact('employee'));
