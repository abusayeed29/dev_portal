	...
	<div class="main-wrapper" id="app">
		...
		<div class="page-wrapper">
			...
			<footer class="footer d-flex flex-column flex-md-row align-items-center justify-content-between">
				<p class="text-muted text-center text-md-left">Copyright © 2022 <a href="#" target="_blank">NAVANA</a>. All rights reserved</p>
				<p class="text-muted text-center text-md-left mb-0 d-none d-md-block">Design & Developed By Navana MIS</p>
			</footer>
			<!-- partial -->
