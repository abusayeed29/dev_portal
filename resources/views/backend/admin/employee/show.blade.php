                    ...
                    <div class="position-relative">
                        ...
                        <div class="cover-body d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-none d-md-block me-5">
                                <button type="button" class="btn btn-primary btn-icon-text btn-edit-profile" data-bs-toggle="modal" data-bs-target="#userUpdateModal_2">
                        ...
                        <div class="row pb-0">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control" name="designation" id="designationId">
                                    ...
                                    @foreach(App\Models\Designation::where('company_id','=', $employee->company_id)->get() as $designation)
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" disabled id="email" name="email" value="{{$employee->email}}" placeholder="Enter email">
                                </div>
                            </div>
