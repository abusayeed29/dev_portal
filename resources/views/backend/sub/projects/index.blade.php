                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <a href="{{route('user.projects.edit',$project->id)}}" class="btn btn-light btn-sm btn-sm-custom"><i data-feather="edit-2" width="18" height="18"></i></a>
                                    <a href="{{route('user.projects.show',$project->id)}}" class="btn btn-light btn-sm btn-sm-custom"><i data-feather="eye" width="18" height="18"></i></a>
                                    ...
                                    <a href="{{route('user.projects.show',$project->id)}}" class="btn btn-light btn-sm btn-sm-custom"><i data-feather="download" width="18" height="18"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="{{ route('user.projects.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
